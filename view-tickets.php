                  ...
                  <?php if ($row['admin_remark'] != '') : ?>
                    <div class="form-actions">
                      <div class="post col-md-12">
                        <div class="user-profile-pic-wrapper">
                          <div class="user-profile-pic-normal"> <img width="35" height="35" data-src-retina="assets/img/logo1.png" data-src="assets/img/logo1.png" src="assets/img/logo1.png" alt="Admin"> </div>
                        </div>
                        <div class="info-wrapper">
