   ...
   <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
     <div class="user-info-wrapper">
       <div class="profile-wrapper" style="border:solid #fff 1px;">
         <img src="../assets/img/logo1.png" alt="" data-src="../assets/img/logo1.png" data-src-retina="../assets/img/logo1.png" class="side-user-img" />
       </div>
       <div class="user-info">
         <div class="greeting">Bienvenid@</div>
         <div class="username">ACG TECNOLOGIAS</div>
