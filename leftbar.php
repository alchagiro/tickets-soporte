 ...
 <div class="page-sidebar" id="main-menu">
   ...
   <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
     <div class="user-info-wrapper">
       ...
       <div class="user-info">
         <div class="greeting" style="font-size:18px;">Bienvenid@</div>
         <div class="username" style="font-size:16px;"><?php echo $_SESSION['name']; ?></div>
         <div class="status" style="font-size:14px;"><a href="#">
